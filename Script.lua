...
FEVS.Name = "FEVS"
FEVS.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
FEVS.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
local fevDir = game:GetService("Players").LocalPlayer.PlayerGui.FEVS
...
Tab.Text = "FNB' Auto-Player - Selection"
...
OptionA.Text = "(Recommended) w/ Warning"
OptionA.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/o5u3/Friday-Night-Bloxxin-Autoplayer/main/Warning"))()
end)
...
OptionB.Position = UDim2.new(0.305609286, 0, 0.700598836, 0)
...
OptionB.Text = "Without Warning"
OptionB.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/o5u3/Friday-Night-Bloxxin-Autoplayer/main/without-Warning"))()
end)
